...
<main class="container my-4">
  <section class="quiz-container">
    ...
    <!-- FORMULÁRIO DO QUIZ -->
    <!-- O formulário é usado para agrupar as perguntas e os inputs do usuário -->
    <form id="quizForm">
      ...
      <div class="mb-3">
        ...
        <!-- Cada input radio representa uma opção -->
      ...
      <div class="mb-3">
        ...
        <!-- Checkboxes permitem múltiplas respostas -->
        <div class="form-check">
    ...
    <!-- Local onde o resultado será exibido dinamicamente -->
...
<script>
  ...
  document.getElementById("quizForm").addEventListener("submit", function(event) {
    ...
    let pontos = 0; // Variável da pontuação final
    let mensagens = ""; // Acumula feedback

    // -----------------------
    // VALIDAÇÃO E CORREÇÃO
    // -----------------------

    // Pergunta 1 - resposta correta: Goku
    ...
    // Pergunta 2 - respostas corretas: Thor e Homem de Ferro
    ...
    // Pergunta 3 - resposta correta: 2012
    ...
    // Inserção dinâmica de elemento extra
    if (pontos === 3) {
